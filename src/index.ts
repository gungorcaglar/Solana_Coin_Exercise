...
async function main() {
  ...
  const MINT_ADDRESS = "J3scqhCkCL6R9LoTq5Mt9a1iW3Jgy5gBmFsp3YqNBMMD"
  ...
  await createTokenMetadata(
    ...
    user,
    "CaglarCoin", // Token name - REPLACE THIS WITH YOURS
    "CGLR",     // Token symbol - REPLACE THIS WITH YOURS
    "Whoever holds this token is invited to my home party" // Token description - REPLACE THIS WITH YOURS
  )
}
